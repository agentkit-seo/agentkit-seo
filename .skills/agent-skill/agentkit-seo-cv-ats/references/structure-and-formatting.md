...
- keep contact details in the body, not in headers or footers
- write URLs explicitly
- use one unambiguous date format throughout the document
- put the full name alone on the first line of the CV
