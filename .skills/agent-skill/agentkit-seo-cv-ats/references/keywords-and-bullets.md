...
- duty-only bullets
- giant skill dumps
- repeating the same keyword in multiple trivial variants
- unsupported claims with no measurable result
- summary sections that read like pasted job descriptions
