...
%
% Reference: AgentKit SEO - cv-ats module
...
% - cv-ats/formatting-rules.md (Single-column layout, standard fonts)
% - cv-ats/agent-workflow.md (Macro-driven content injection)
% - cv-ats/common-pitfalls.md (No hidden tables, use \hfill for alignment)
% ==============================================================================
...
% avoiding the "invisible table hack" failure (see cv-ats/common-pitfalls.md).
...
% Reference: cv-ats/core-sections.md
...
% Reference: cv-ats/keyword-strategy.md
...
% WORK EXPERIENCE
% Reference: cv-ats/core-sections.md
% Rule: Reverse-chronological order. Strict MM/YYYY date format.
% Reference: cv-ats/achievement-metrics.md
...
fication Name] ([Issuing Organization], [Year])
    \item \textbf{Languages:} [Language 1] ([Proficiency]), [Language 2] ([Proficiency])
\end{itemize}
